...
public class AlarmScreen extends Activity {
    ...
    private class postAsyncTask extends AsyncTask<String, Integer, Double> {
        ...
        public void postData(String valueIWantToSend) {
            ...
            HttpPost httppost = new HttpPost("http://snooze-api.ngrok.com/balance");
            ...
            try {
                ...
                String httpText = response.toString();
                Context context = getApplicationContext();
                CharSequence text = httpText;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        snoozeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Context context = getApplicationContext();
                CharSequence text = "Now  Snoozing!";
                int duration = Toast.LENGTH_SHORT;

                Toast toast = Toast.makeText(context, text, duration);
                toast.show();
                Log.d("Test", "testlog");
;                new postAsyncTask().execute("Somestring".toString());
